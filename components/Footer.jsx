            ...
            <div className="arima mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="space-y-8">
                        <Image className="h-50" src="/assets/logo.webp" width={250} height={150} alt="Your Handyman Company Logo" />
                        ...
                        <div>
                            ...
                            <ul className="mt-6 space-y-4">
                                <li className="flex items-center">
                                    <svg className="h-6 w-6 mr-2 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                    </svg>
                                    <a href="tel:+11234567890" className="text-sm leading-6 text-gray-300 hover:text-white">(123) 456-7890</a>
                                </li>
                                <li className="flex items-center">
                                    <svg className="h-6 w-6 mr-2 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                    </svg>
                                    <a href="mailto:info@example.com" className="text-sm leading-6 text-gray-300 hover:text-white">info@example.com</a>
                                </li>
                                <li className="flex items-center">
                                    <svg className="h-6 w-6 mr-2 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                    ...
                                    <span className="text-sm leading-6 text-gray-300">Madison, WI</span>
                                </li>
                            </ul>
                ...
                <div className="mt-8 border-t border-white/10 pt-8 sm:mt-20 lg:mt-16">
                    <nav className="flex flex-wrap justify-center md:justify-start gap-6 mb-4 md:mb-0" aria-label="Footer">
                    ...
                    <p className="mt-4 text-xs leading-5 text-gray-100 text-center md:text-left">&copy; {new Date().getFullYear()} Your Handyman Company, Inc. All rights reserved.</p>
                    <p className="raleway mt-2 text-xs leading-5 text-gray-100 text-center">
                        Created by <a href="https://novsweb.com" className="hover:underline" target="_blank" rel="noopener noreferrer">Novs Web Design Group</a>
                    </p>
                </div>
            </div>
        </footer>
