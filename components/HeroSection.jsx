...
const HeroSection = () => {
  return (
    <div className="arima flex flex-col lg:flex-row items-center justify-between bg-gray-100 p-4 lg:p-8">
      <div className="w-full lg:w-1/2 mb-8 lg:mb-0 flex flex-col lg:mt-20 justify-center lg:pr-8">
        <h1 className="text-4xl md:text-5xl lg:text-8xl font-bold mb-4">Handyman Service Experts</h1>
        ...
        <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
          ...
          <a href="/services/1" className="px-6 py-2 text-blue-800 hover:bg-blue-500 hover:text-white hover:rounded-2xl text-center">
            Our Services
          </a>
        </div>
      </div>
