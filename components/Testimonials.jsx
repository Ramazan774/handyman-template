        ...
        <div className="nunito grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-x-8">
          ...
          <figure className="mx-auto max-w-2xl">
            ...
            <blockquote className="mt-10 text-xl font-medium leading-8 tracking-tight text-gray-900 sm:text-2xl sm:leading-9">
              <p>{`"The team at Madison Handyman Services did an exceptional job with my home repairs. Their attention to detail and professionalism were outstanding. I could not be happier with the results!"`}</p>
            </blockquote>
            <figcaption className="mt-10 flex items-center gap-x-6">
              <div className="text-sm leading-6">
                <div className="font-semibold text-gray-900">Sarah Johnson</div>
                <div className="mt-0.5 text-gray-600">Homeowner</div>
              </div>
            </figcaption>
          </figure>
          ...
          <figure className="mx-auto max-w-2xl">
            ...
            <blockquote className="mt-10 text-xl font-medium leading-8 tracking-tight text-gray-900 sm:text-2xl sm:leading-9">
              <p>{`"I have used many handyman services before, but none compare to the quality and reliability of this team. They are my go-to for all home improvement projects now."`}</p>
            </blockquote>
            <figcaption className="mt-10 flex items-center gap-x-6">
              <div className="text-sm leading-6">
