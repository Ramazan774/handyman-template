          ...
          <div className="w-full lg:w-1/2 relative">
            <div className="aspect-[2/1] relative w-full h-[400px] sm:h-[500px] lg:h-[600px]">
              <Image
                ...
                alt="Professional mounting a large TV on a wall"
                layout="fill"
                objectFit="cover"
              />
            </div>
            <div className="aspect-[3/2] w-2/3 absolute -bottom-16 -right-8 translate-y-1/4 hidden lg:block">
              <Image
                ...
                alt="Close-up of TV mount installation"
                layout="fill"
                objectFit="cover"
              />
            </div>
...
const TVMounting = () => {
    const title = "TV Mounting";
    const description = `Our professional TV mounting service ensures your television is securely and 
    aesthetically installed in your home or office. We handle all types and sizes of TVs, from small 
    bedroom sets to large living room displays. Our experienced technicians will help you choose the 
    perfect location, conceal cables for a clean look, and ensure your TV is level and properly secured. 
    We also offer advice on the best mounting solutions for your specific needs and room layout.`;
    ...
    return (
        <>
            <Head>
                ...
                <link rel="canonical" href="https://yourwebsite.com/services/tv-mounting" />
            </Head>
